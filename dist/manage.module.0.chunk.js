...
var ManageComponent = /** @class */ (function () {
    function ManageComponent(fb, activeRoute, modelService, navService, ngbModel, arrestService, proveService, router, sidebarService, preloader) {
        var _this = this;
        this.fb = fb;
        ...
        this.lawbreakerType = __WEBPACK_IMPORTED_MODULE_22__models__["e" /* LawbreakerTypes */];
        this.entityType = __WEBPACK_IMPORTED_MODULE_22__models__["c" /* EntityTypes */];
    ...
    ManageComponent.prototype.createForm = function () {
        var ArrestDate = this.mode == 'C' ? Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["e" /* setDateMyDatepicker */])(new Date()) : null;
        var ArrestTime = this.mode == 'C' ? Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["f" /* setZero */])((new Date).getHours()) + "." + Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["f" /* setZero */])((new Date).getMinutes()) + " \u0E19." : null;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        sDateCompare = Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["c" /* getDateMyDatepicker */])(this.arrestFG.value.ArrestDate);
                        eDateCompare = Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["c" /* getDateMyDatepicker */])(this.arrestFG.value.OccurrenceDate);
                        if (sDateCompare.valueOf() > eDateCompare.valueOf()) {
                            alert(__WEBPACK_IMPORTED_MODULE_8__config_message__["a" /* Message */].checkDate);
                            return [2 /*return*/, false];
                        }
                        this.arrestFG.value.ArrestDate = Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["g" /* setZeroHours */])(sDateCompare);
                        this.arrestFG.value.OccurrenceDate = Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["g" /* setZeroHours */])(eDateCompare);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.proveService.getProveProductUnit('').then(function (res) {
                            _this.typeheadQtyUnit = res;
                            _this.typeheadNetVolumeUnit = res;
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.arrestFG.reset({
                            ...
                            ArrestDate: Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["e" /* setDateMyDatepicker */])(new Date(res.ArrestDate)),
                            ArrestTime: res.ArrestTime,
                            OccurrenceDate: Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["e" /* setDateMyDatepicker */])(new Date(res.OccurrenceDate)),
    ...
    ManageComponent.prototype.setNoticeForm = function (notice) {
        ...
        var locale = notice.NoticeLocale[0];
        var product = notice.NoticeProduct;
        var lawbreaker = [];
        ...
        for (var i = 0; i < this.ArrestProduct.length; i++) {
...
var ManageModule = /** @class */ (function () {
    ...
    ManageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_8__arrests_service__["a" /* ArrestsService */], __WEBPACK_IMPORTED_MODULE_17__prove_prove_service__["a" /* ProveService */]]
        })
    ], ManageModule);
    return ManageModule;
}());
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, list.map(function (item, i) {
                                item.RowId = i + 1;
                                item.IsChecked = false;
                                item.NoticeDate = Object(__WEBPACK_IMPORTED_MODULE_5__config_dateFormat__["i" /* toLocalShort */])(item.NoticeDate);
