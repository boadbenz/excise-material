...
var InvestigateTeamFormControl = {
    ...
    ProgramCode: new __WEBPACK_IMPORTED_MODULE_0__angular_forms__["d" /* FormControl */](null),
    ProcessCode: new __WEBPACK_IMPORTED_MODULE_0__angular_forms__["d" /* FormControl */](null),
    ...
    ContributorID: new __WEBPACK_IMPORTED_MODULE_0__angular_forms__["d" /* FormControl */](null),
    IsActive: new __WEBPACK_IMPORTED_MODULE_0__angular_forms__["d" /* FormControl */](1, __WEBPACK_IMPORTED_MODULE_0__angular_forms__["m" /* Validators */].required),
};
...
var ManageComponent = /** @class */ (function () {
    ...
    ManageComponent.prototype.createForm = function () {
        this.investigateForm = this.fb.group({
            InvestigateCode: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormControl */](this.investCode, __WEBPACK_IMPORTED_MODULE_5__angular_forms__["m" /* Validators */].required),
            InvestigateNo: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormControl */](null),
            DateStart: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormControl */](null),
            DateEnd: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormControl */](null),
            Subject: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormControl */](null),
            InvestigateTeam: this.fb.array([this.createTeam()])
        });
    };
    ManageComponent.prototype.createTeam = function () {
        __WEBPACK_IMPORTED_MODULE_7__investigate_team__["b" /* InvestigateTeamFormControl */].InvestigateCode = new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormControl */](this.investCode);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        sDateCompare = new Date(Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["e" /* resetLocalNumeric */])(this.investigateForm.value.DateStart));
                        eDateCompare = new Date(Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["e" /* resetLocalNumeric */])(this.investigateForm.value.DateEnd));
    ...
    ManageComponent.prototype.getByCon = function (InvestigateCode) {
        ...
        this.sub = this.invesService.getByCon(InvestigateCode).subscribe(function (item) {
            _this.investigateForm.reset({
                ...
                DateStart: Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["i" /* toLocalNumeric */])(item.DateStart),
                DateEnd: Object(__WEBPACK_IMPORTED_MODULE_6__config_dateFormat__["i" /* toLocalNumeric */])(item.DateEnd),
