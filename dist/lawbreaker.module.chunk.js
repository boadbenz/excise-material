...
var LawbreakerComponent = /** @class */ (function () {
    function LawbreakerComponent(ngModalService, router, activatedRoute, preloader, navService, fb, arrestService, noticeService) {
        var _this = this;
        ...
        this.visaTypes = __WEBPACK_IMPORTED_MODULE_4__models__["k" /* VISATypes */];
        this.bloodTypes = __WEBPACK_IMPORTED_MODULE_4__models__["a" /* BloodTypes */];
        this.entityTypes = __WEBPACK_IMPORTED_MODULE_4__models__["c" /* EntityTypes */];
        this.genderTypes = __WEBPACK_IMPORTED_MODULE_4__models__["d" /* GenderTypes */];
        this.LawbreakerTypes = __WEBPACK_IMPORTED_MODULE_4__models__["e" /* LawbreakerTypes */];
        this.titleNames = __WEBPACK_IMPORTED_MODULE_4__models__["j" /* TitleNames */];
        this.nationnalitys = __WEBPACK_IMPORTED_MODULE_4__models__["g" /* Nationalitys */];
        this.races = __WEBPACK_IMPORTED_MODULE_4__models__["h" /* Races */];
        this.religions = __WEBPACK_IMPORTED_MODULE_4__models__["i" /* Religions */];
        this.materialStatus = __WEBPACK_IMPORTED_MODULE_4__models__["f" /* MaritalStatus */];
        this.typeheadRegion = [];
        ...
        this.onSaveSubscribe = this.navService.onSave.subscribe(function (status) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        birthDay = Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["c" /* getDateMyDatepicker */])(this.LawbreakerFG.value.BirthDate);
                        passportDateIn = Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["c" /* getDateMyDatepicker */])(this.LawbreakerFG.value.PassportDateIn);
                        passportDateOut = Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["c" /* getDateMyDatepicker */])(this.LawbreakerFG.value.PassportDateOut);
                        this.LawbreakerFG.value.BirthDate = Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["g" /* setZeroHours */])(birthDay);
                        this.LawbreakerFG.value.PassportDateIn = Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["g" /* setZeroHours */])(passportDateIn);
                        this.LawbreakerFG.value.passportDateOut = Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["g" /* setZeroHours */])(passportDateOut);
                        if (this.mode === 'C') {
                            this.OnCreate();
                        }
                        else if (this.mode === 'R') {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.noticeService.getLawbreakerByCon(LawbreakerID).then(function (res) {
                            _this.LawbreakerFG.reset({
                                ...
                                PassportDateIn: Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["e" /* setDateMyDatepicker */])(res.PassportDateIn),
                                PassportDateOut: Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["e" /* setDateMyDatepicker */])(res.PassportDateOut),
                                BirthDate: Object(__WEBPACK_IMPORTED_MODULE_17__config_dateFormat__["e" /* setDateMyDatepicker */])(res.BirthDate),
