        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                this.results = list.map(function (item, i) {
                    item.RowsId = i + 1;
                    item.ArrestDate = Object(__WEBPACK_IMPORTED_MODULE_13__config_dateFormat__["j" /* toLocalShort */])(item.ArrestDate);
                    item.LawsuitDate = Object(__WEBPACK_IMPORTED_MODULE_13__config_dateFormat__["j" /* toLocalShort */])(item.LawsuitDate);
