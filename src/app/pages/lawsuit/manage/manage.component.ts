...
export class ManageComponent implements OnInit {
  ...
  ArrestgetByCon(IndictmentID: string) {
    return this.lawsuitService.LawsuitArrestGetByCon(IndictmentID).then(async response => {
      if (response.length > 0) {
        ...
        this.fixFullName()
        await this.checkComplete(result.LawsuitArrestIndicment[0])
        return result;
      }
      else return {};
    })
  ...
  async setLawsuit(LawsuitArrestIndicment) {
    ...
    this.lawsuitForm.LawsuitDate = this.convertDate(this.lawsuitForm.LawsuitDate)
  ...
  convertDate(date) {
    if (date) {
      ...
      return { date: { year: (Number(cutDate[0]) + 543), month: Number(cutDate[1]) + 1, day: Number(cutDate[2].substr(0, 2)) } };
    } else {
      return null;
    }
  }
...
//               alert("บันทึกสำเร็จ")
//               let checkNotComplete = await this.lawsuitService.LawsuitArrestCheckNotComplete(this.lawsuitArrestForm.controls['ArrestCode'].value)
//               // if(checkNotComplete.length > 0) {}
//             }
//           });
//         }
//       });
...
//             });
//             /// get IsLaxxwsuit check box (IsLawsuitCheck)
...
//   //     this.lawsuitForm.controls['LawsuitNo'].setValidators([Validators.required]);
//   //     this.lawsuitForm.controls['LawsuitNoSub'].setValidators([Validators.required]);
//   //     this.lawsuitForm.controls['LawsuitDate'].setValidators([Validators.required]);
//   //     this.lawsuitForm.controls['LawsuitTime'].setValidators([Validators.required]);
//   //     this.lawsuitForm.controls['FullName'].setValidators([Validators.required]);
//   //     this.lawsuitForm.controls['LawsuitStation'].setValidators([Validators.required]);
//   //     this.lawsuitForm.controls['AccuserTestimony'].setValidators([Validators.required]);
//   //   } else {
//   //     this.lawsuitForm.controls['LawsuitNo'].clearValidators();
//   //     this.lawsuitForm.controls['LawsuitNoSub'].clearValidators();
//   //     this.lawsuitForm.controls['LawsuitDate'].clearValidators();
//   //     this.lawsuitForm.controls['LawsuitTime'].clearValidators();
//   //     this.lawsuitForm.controls['FullName'].clearValidators();
//   //     this.lawsuitForm.controls['LawsuitStation'].clearValidators();
//   //     this.lawsuitForm.controls['AccuserTestimony'].clearValidators();
//   //   }
//   // }
