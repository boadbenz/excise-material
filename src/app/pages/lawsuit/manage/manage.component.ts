...
export class ManageComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    let arrestList = await this.ArrestgetByCon(this.IndictmentID, this.LawsuitID);
    await this.createLawsuitArrestForm(arrestList)
    this.preLoaderService.setShowPreloader(false);
    // toolsBar
  }
  ...
  private setLawsuitForm() {
    this.lawsuitForm = this.fb.group({
      ...
      LawsuitTableList: this.fb.array([this.setTableListForm()]),
      LawsuitDocument: this.fb.array([]),
      officeCode: new FormControl(null),
    });
  }
  ...
  private setTableListForm(): FormGroup {
    return this.fb.group({
      EntityType: new FormControl(null),
      LawbreakerType: new FormControl(null),
      LawsuitNoRef: new FormControl(null),
