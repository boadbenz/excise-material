        ...
        await this.lawsuitService.LawsuitArrestGetByCon(params.IndictmentID).then(res => {
          ...
          if(res) {
            ...
            if(IsLawsuitComplete == 1
                && (this.lawsuitList || []).length > 0
                && (this.lawsuitList[0]['LawsuitArrestIndicment'] || []).length > 0
                && (this.lawsuitList[0]['LawsuitArrestIndicment'][0]['Lawsuit'] || []).length > 0 ) {
